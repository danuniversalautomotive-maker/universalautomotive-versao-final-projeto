...
import { deleteClientLastCart, getClientLastCart, updateClientLastCart } from './middlewares/clientLastCart'
...
export default new Service({
  clients,
  routes: {
    clientLastSessionCart: method({
      GET: [getClientLastCart],
      POST: [updateClientLastCart],
      DELETE: [deleteClientLastCart]
    }),
