          ...
          <div key={`ifany_${i}`}>
            {b.items.length
              ? b.items.map((content: any) => {
                  ...
                  return (
                    <div
                      className="flex flex-row bg-white hover-bg-near-white"
                      key={`prod_${i}_${content.itemId}`}
                    >
                      <div
                        className={`flex flex-row fl ${handles.categoryProductLabel}`}
                      >
                        <span className={handles.categoryProductTitle}>
                          {content.nameComplete}
                        </span>
                        <div className={handles.refIdAndQuantityWrapper}>
                          {referenceId && (
                            <span
                              className={`${handles.categoryProductReference}`}
                            >
                              {referenceId.Value}
                            </span>
                          )}
                          ...
                          <div
                            className={`flex flex-column  p fl ${handles.categoryInputQuantity}`}
                          >
                            <Input
                              ...
                              onChange={(e: any) => {
                                ...
                                const seller = content.sellers.find(
                                  (s: any) => {
  ...
  const collapsible = (item: any) => {
    return (
      ...
      >
        ...
        {item.hasChildren && (
          <div className={`${handles.categoriesSubCategory}`}>
