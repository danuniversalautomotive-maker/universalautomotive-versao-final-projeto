...
import { Tag, ToastContext, IconClear } from 'vtex.styleguide'
...
const AutocompleteBlock: FunctionComponent<any & WrappedComponentProps> = ({
  ...
  const CSS_HANDLES = [
    ...
    'componentContainer',
    'buttonClear',
    'quantityAddToCartRemoveWrapper',
  ...
  return (
    <div className={`${handles.autoCompleteBlock}`}>
      ...
      >
        <div className="">
          <div className="bg-base t-body c-on-base  br3 b--muted-4">
            {!selectedItem && <QuickOrderAutocomplete onSelect={onSelect} />}
            {!!selectedItem && (
              <div className={`${handles.productInfoContainer}`}>
                <div className="fl-l">
                  <div
                    className={`flex flex-column  fl ${handles.productThumb}`}
                  >
                    <img
                ...
                <div className={`${handles.quantityAddToCartRemoveWrapper}`}>
                  <div>
                    <input
