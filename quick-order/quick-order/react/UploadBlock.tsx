...
import { DownloadModelIcon } from './assets/DownloadModelIcon'
          ...
          <div className="w-100 mb5">
            ...
            >
              <Dropzone
                ...
                className={handles.dropzoneStyles}
                accept=".xls,.xlsx"
              ...
              >
                <div className="pt7">
                  <div>
                    <span
                      className={`flex flex-col upload-block-texts`}
                      style={{ cursor: 'pointer' }}
                    >
                      <span className="selectFileText">
                        <FormattedMessage id="store/quickorder.selectText.file" />{' '}
                      </span>
                      <FormattedMessage id="store/quickorder.xslText.file" />
                    </span>
